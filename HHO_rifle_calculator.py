...
class o2:
    pressure = environment.pressure / 3  # Pa
...
class hydrogen:
    pressure = environment.pressure / 2  # Pa  | Required partial pressure to acquire the middle of the flammable limits (considered the most explosive ratio)
    volume = chamber.volume / 1000  # m³
...
hydrogen_number_of_moles = o2_number_of_moles * 2

used_hydrogen = o2_number_of_moles * 2  # mol
reaction_efficiency = used_hydrogen / hydrogen_number_of_moles


class number_of_moles:
    # Note: 2H2 + O2 → 2H2O
    products = used_hydrogen
    leftover_hydrogen = hydrogen_number_of_moles - used_hydrogen
    atmospheric_gases = o2_number_of_moles * (environment.pressure / o2.pressure)
    all_gases_after_reaction = products + leftover_hydrogen + atmospheric_gases
    h2o = products
...
combustion_energy = (enthalpy_of_formation.hydrogen * used_hydrogen) - (enthalpy_of_formation.h2o * number_of_moles.h2o) #kJ
